...
class EditUserPage extends Component {
    ...
    handleSaveEdit(){
        ...
        users[this.state.selected] = selectedUser;
            ...
            return <div className="static-modal">
                        <Modal show={this.state.selectedUser.hasOwnProperty("name") && this.state.action == "Edit"} container={this} style={{top:"125px"}}>
                            ...
                            <Modal.Body style={{height:"200px",overflowY:"scroll"}}>
                                ...
                                <div className="col-md-12">
                                    <TextField floatingLabelText="ID" name="employeeId" style={{ width: "100%" }} defaultValue={this.state.selectedUser.employeeId} onChange={this.handleChange.bind(this)} floatingLabelFocusStyle={{color:"#6441A4"}} underlineFocusStyle={{borderColor:"#6441A4"}} />
                                </div>
                                <div className="col-md-12">
                                ...
                                {this.state.users.map(function (user, i) {
                                    return (
                                        <TableRow key={i} selected={self.isSelected(i)}>
                                            ...
                                            <TableRowColumn>{user.position}</TableRowColumn>
